...
module registry './shared/registry.bicep' = {
  ...
  params: {
    ...
    agentPoolSubnetId: networking.?outputs.?privateEndpointsSubnetId ?? ''
  }
}
...
module appsEnv './shared/apps-env.bicep' = {
  ...
  params: {
    ...
    // VNet integration for OUTBOUND traffic: allows Container App to reach PE-locked services
    // internal remains false so the React SPA (browser) can reach the API directly
