...
const GetStartedButton: React.FC<GetStartedButtonProps> = ({ onQuerySelect }) => {
  ...
  // Uses NAIP aerial imagery (0.6m resolution) — high enough to see individual buildings and damage.
  // HLS/Sentinel-2 (10-30m) are too coarse for building-level damage assessment.
                  ...
                  <div className="comparison-queries-section">
                    ...
                    <div className="comparison-queries-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '12px' }}>
                      <div className="example-card comparison-card">
                        ...
                        <div className="setup-query" style={{ flexDirection: 'column', gap: '6px' }}>
                          <div style={{ fontSize: '12px', color: '#94a3b8' }}>
                            <strong>1.</strong> Navigate to Paradise, CA and drop a pin<br/>
                            <strong>2.</strong> Type in chat:
                          </div>
                      ...
                      <div className="example-card comparison-card">
                        ...
                        <div className="setup-query" style={{ flexDirection: 'column', gap: '6px' }}>
                          <div style={{ fontSize: '12px', color: '#94a3b8' }}>
                            <strong>1.</strong> Navigate to NYC coastline and drop a pin<br/>
                            <strong>2.</strong> Type in chat:
                          </div>
