...
export async function fetchAndSignTileJSON(
  ...
  try {
    ...
    try {
      ...
      if (!response.ok) {
        console.error(` [TileJsonFetcher] TileJSON fetch failed: ${response.statusText}`);
        return {
          success: false,
...
async function signMPCUrl(url: string): Promise<string> {
  ...
  try {
    ...
    if (data.signed_url) {
      ...
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.warn(' [MPC AUTH] No signed_url in response!');
      console.warn(' [MPC AUTH] Response data:', JSON.stringify(data));
      console.warn(' [MPC AUTH] Using original unsigned URL');
      console.warn(' [MPC AUTH] This may result in low-resolution tiles');
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      return url;
    }
  } catch (error) {
